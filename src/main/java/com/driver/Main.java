...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        gmail.receiveMail(new SimpleDateFormat("dd/MM/yyyy").parse("22/12/2022"), "Abhishek", "Assignment to be uploaded on the database.");
        ...
        gmail.deleteMail("Assignment to be uploaded on the database.");
        System.out.println("There are " + gmail.getTrashSize() + " mails in the trash.");
        gmail.emptyTrash();
        System.out.println("There are " + gmail.getTrashSize() + " mails in the trash.");

        Workspace workspace = new Workspace("accio@gmail.com");
        System.out.println("Inbox capacity is " + workspace.getInboxCapacity() + " in the workspace.");
